...
import pl.dev.bkwiatkowski.feature.dashboard.presentation.changepassword.provider.ChangePasswordPreviewProvider
...
fun ChangePasswordScreen(viewModel: ChangePasswordVM) {
  ...
  when (val data = screenData) {
    is ChangePasswordVM.ScreenData.ErrorScreen -> ErrorScreen(data = data.errorData)
    is ChangePasswordVM.ScreenData.ChangePasswordScreen -> ChangePasswordScreenContent(data = data)
  }
...
fun ChangePasswordScreenContent(
  data: ChangePasswordVM.ScreenData.ChangePasswordScreen,
) {
  BaseScaffold(
    ...
    content = {
      Column(
        ...
        TextField(textFieldData = data.oldPasswordFieldData)
...
private fun ChangePasswordScreenPreview(
  @PreviewParameter(provider = ChangePasswordPreviewProvider ::class) viewModel: ChangePasswordVM,
) {
